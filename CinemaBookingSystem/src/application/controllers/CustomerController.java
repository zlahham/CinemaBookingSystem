...
public class CustomerController extends MainController {
	public void viewBookings(ActionEvent event) {
		...
		try {
			...
			viewBookings = FXMLLoader.load(getClass().getResource("/application/views/ViewBookings.fxml"));
	...
	public void changeDetails(ActionEvent event) {
		...
		try {
			changeDetails = FXMLLoader.load(getClass().getResource("/application/views/Profile.fxml"));
